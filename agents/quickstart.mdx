...
Origami skill. It teaches your assistant the calls above — when to start an agent, how to
...
config under `$HOME`). Set `ORIGAMI_API_KEY` in your shell or `.env` and re-run any time
to update.
